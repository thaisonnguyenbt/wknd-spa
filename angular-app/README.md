...
After running `npm start` **in the `angular-app` directory**, your app will be automatically opened in your browser (at path http://localhost:4200/content/wkndspa/en/home.html). If you make edits, the page will reload.
